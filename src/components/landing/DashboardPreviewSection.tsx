      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="relative mt-12 overflow-hidden rounded-2xl border border-[var(--border)] bg-card shadow-[0_24px_80px_rgba(0,0,0,0.5)]">
          ...
          <div className="relative flex flex-col lg:flex-row lg:min-h-[420px]">
            <aside className="border-b border-[var(--border)] bg-secondary/40 p-3 lg:w-48 lg:shrink-0 lg:border-b-0 lg:border-r">
              ...
              <nav className="flex flex-wrap gap-1 lg:flex-col">
                {sidebar.map((item) => {
                  ...
                  return (
                    <div
                      key={item.label}
                      className={`flex min-w-0 items-center gap-2 rounded-md px-2 py-1.5 text-xs font-medium ${
                        item.active
