...
const primarySurface = {
  ...
  boxShadow:
    "0 2px 4px 0 rgba(194, 61, 72, 0.4), 0 1.5px 0 0 rgba(255,255,255,0.22) inset, 0 -2px 4px 0 rgba(100, 28, 36, 0.55) inset",
} as const;

const secondarySurface = {
  background: "linear-gradient(to bottom, rgb(45, 45, 45), rgb(20, 20, 20))",
  boxShadow:
    "0 2px 4px 0 rgba(0, 0, 0, 0.45), 0 1.5px 0 0 rgba(255,255,255,0.12) inset, 0 -2px 4px 0 rgba(0, 0, 0, 0.35) inset",
} as const;

const primaryInnerRing =
  "0 0 0 2px rgba(255,255,255,0.08) inset, 0 1.5px 0 0 rgba(255,255,255,0.16) inset, 0 -2px 4px 0 rgba(194, 61, 72, 0.15) inset";

const secondaryInnerRing =
  "0 0 0 2px rgba(255,255,255,0.07) inset, 0 1.5px 0 0 rgba(255,255,255,0.1) inset, 0 -2px 4px 0 rgba(0,0,0,0.25) inset";
...
export function PlasticButton({
  ...
  const variantInteractive =
    variant === "primary"
      ? cn(
          "text-white",
          "hover:-translate-y-0.5 hover:scale-[1.02] hover:brightness-105 hover:drop-shadow-[0_0_14px_rgba(248,113,113,0.3)]",
      ...
      : cn(
          ...
          "hover:-translate-y-0.5 hover:border-white/25 hover:text-white hover:brightness-110 hover:drop-shadow-[0_0_12px_rgba(255,255,255,0.08)]",
          "active:translate-y-0 active:scale-[0.99]",
